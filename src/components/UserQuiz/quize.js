          ...
          answers: [
            {
              ...
              isRight: false,
              explanation:
                '<p>Подумай еще немного, в выбранном тобой ответе присутствует символ "@" который позволяет вводить буквенные символы верхнего регистра.</p><p>Помни, ошибаться нельзя, ты дал не верный ответ, сумма твоего вознаграждения уменьшена.</p>',
              isChecked: false,
            },
            {
              text: "+9(999)9999999",
              isRight: false,
              explanation:
                '<p>Подумай еще немного, в выбранном тобой ответе второй символ это "9", что позволит пользователю вместо кода страны &laquo;+7&raquo; ввести любую цифру.</p><p>Помни, ошибаться нельзя, ты дал не верный ответ, сумма твоего вознаграждения уменьшена.</p>',
              isChecked: false,
            },
            {
            ...
            },
            {
              ...
              isChecked: false,
              explanation:
                '<p>Подумай еще немного, в выбранном тобой ответе присутствует символ "X" который обозначает, что вводиться могут любые символы латиницы, а также символ "@", который позволяет вводить буквенные символы верхнего регистра.</p><p>Помни, ошибаться нельзя, ты дал не верный ответ, сумма твоего вознаграждения уменьшена.</p>',
            },
          ],
        },
      ],
