<template>
  <div class="user-quiz">
    ...
    <div class="content-wrapper styled-scrollbars">
      <div
        class="content"
        :class="{ 'content--hidden': !isShowedQuestion && isUserCanBegin }"
      >
        <button
        ...
        <div
          class="question styled-scrollbars"
          v-if="isShowedQuestion"
          v-html="currentTaskStep.question"
        ></div>
    ...
    <div class="user-quiz__tips">
      ...
      <div
        class="user-quiz__tip-text styled-scrollbars"
    ...
    <transition-group name="fade" mode="out-in">
      <div
        class="overlay"
        v-if="isCustomerCall || isCustomerTask || isSkipModal"
      ></div>
      <CustomerCall
      ...
      <CustomerModalTask
        ...
        :video-link="
          isCongrates
            ? currentQuizeStep.congrates.video
            : currentQuizeStep.task.video
        "
        :text="
          isCongrates
            ? currentQuizeStep.congrates.text
            : currentQuizeStep.task.text
        "
      >
      </CustomerModalTask>
      <SkipQuizeModal
...
const addMany = () => {
  const summPerAnswer =
    currentQuizeStep.value.summ / totalCurrentQuizeStep.value;
...
<style>
.user-quiz__tip-text > p,
.customer-modal-task__text > p {
  margin-bottom: 20px;
}
</style>
